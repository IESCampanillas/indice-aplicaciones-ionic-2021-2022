...
Los alumnos que no hayan aprobado la aplicación de Ionic en el primer y/o segundo trimestre, deberán entregarla en la fecha que se indica más abajo, cumpliendo los requisitos que se pedían en ambos casos, es decir, los requerimientos indicados en [este documento](trabajo_ionic_v6.pdf) más el almacenamiento de datos y la autenticación en Firebase.
...
* **Miércoles 30 de marzo**: Repositorio de la aplicación creado y enlazado desde el índice. Título y descripción de la aplicación indicando las principales funcionalidades. 
* **Miércoles 27 de abril**: Revisión del trabajo realizado. La aplicación debe tener ya buena parte de las funcionalidades implementadas. Se deben mostrar capturas de pantalla en el `README.md` del repositorio.
* **Miércoles 18 de mayo**: Presentación de la aplicación.
